...
internal sealed class ExporterFactory : ModelFactory
{
	internal static ExporterFactory DeleteReader;
	...
	public ExporterFactory(QueueReader start, QueueReader end)
	{
		GetterIssuer.DeleteInitializer();
	...
	internal static bool FillReader()
	{
		return DeleteReader == null;
	}

	internal static ExporterFactory FlushReader()
	{
		return DeleteReader;
	}
}
