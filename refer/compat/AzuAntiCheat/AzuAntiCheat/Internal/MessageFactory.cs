...
internal sealed class MessageFactory : ModelFactory
{
	private static MessageFactory StopReader;
	...
	public MessageFactory(QueueReader start, QueueReader end)
	{
		GetterIssuer.DeleteInitializer();
	...
	internal static bool ExcludeReader()
	{
		return StopReader == null;
	}

	internal static MessageFactory InterruptReader()
	{
		return StopReader;
	}
}
