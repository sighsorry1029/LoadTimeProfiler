...
internal sealed class OrderFactory : ModelFactory
{
	private static OrderFactory CallReader;
	...
	public OrderFactory(QueueReader start, QueueReader end)
	{
		GetterIssuer.DeleteInitializer();
	...
	internal static bool ConcatReader()
	{
		return CallReader == null;
	}

	internal static OrderFactory NewReader()
	{
		return CallReader;
	}
}
