...
internal sealed class ValFactory : ModelFactory
{
	internal static ValFactory DestroyReader;
	...
	public ValFactory(QueueReader start, QueueReader end)
	{
		GetterIssuer.DeleteInitializer();
	...
	internal static bool ComputeReader()
	{
		return DestroyReader == null;
	}

	internal static ValFactory DisableReader()
	{
