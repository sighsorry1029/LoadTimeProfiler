...
internal sealed class TestFactory : ModelFactory
{
	internal static TestFactory SortReader;
	...
	public TestFactory(QueueReader start, QueueReader end)
	{
		GetterIssuer.DeleteInitializer();
	...
	internal static bool InsertReader()
	{
		return SortReader == null;
	}

	internal static TestFactory FindReader()
	{
		return SortReader;
	}
}
