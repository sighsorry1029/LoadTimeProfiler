...
public class LocationConfig
{
	...
	public float ExteriorRadius
	{
		get
		{
			return _exteriorRadius ?? 10f;
		}
		set
		{
			_exteriorRadius = value;
		}
	}
	...
	public float InteriorRadius
	{
		get
		{
			return _interiorRadius.GetValueOrDefault();
		}
		set
		{
	...
	public LocationConfig(ZoneSystem.ZoneLocation zoneLocation)
	{
		...
		Location component = zoneLocation.m_prefab.Asset.GetComponent<Location>();
		...
		HasInterior = (bool)component && component.m_hasInterior;
		InteriorRadius = zoneLocation.m_interiorRadius;
		InteriorEnvironment = component?.m_interiorEnvironment;
		...
		ClearArea = (bool)component && component.m_clearArea;
