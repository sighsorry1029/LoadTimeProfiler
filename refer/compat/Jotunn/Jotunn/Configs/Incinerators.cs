...
{
	private static readonly Dictionary<string, string> NamesMap = new Dictionary<string, string> { { "Incinerator", Incinerator } };
	...
	public static string GetInternalName(string incinerator)
	{
		...
		if (NamesMap.TryGetValue(incinerator, out var value))
		{
			return value;
		}
		return incinerator;
